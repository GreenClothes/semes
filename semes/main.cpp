...
int main() {
	...
	std::cout << "[add] ===================\n";
	compatibility_.add_incompatible_part("break", CarType::SEDAN, BreakSystem::BOSCH);
	compatibility_.add_incompatible_part("steering", CarType::SEDAN, SteeringSystem::BOSCH);

	std::cout << "[remove] ===================\n";
	compatibility_.remove_part("break", CarType::SEDAN, BreakSystem::BOSCH);
	compatibility_.remove_part("steering", CarType::SEDAN, SteeringSystem::BOSCH);
	...
	parts.insert({ "break", BreakSystem::BOSCH });
